...
const CreateUser = () => {
  ...
  const validateFields = () => {
    ...
    if (!primaryContactEmail || !/\S+@\S+\.\S+/.test(primaryContactEmail)){
      ...
      newErrors.primaryContactEmail = "Primary contact email must be different from the email";
    }
    ...
    if (
      ...
      newErrors.primaryContactPhoneNumber =
        ...
        newErrors.primaryContactPhoneNumber = "Primary contact Number must be different from the PhoneNumber";
      }
